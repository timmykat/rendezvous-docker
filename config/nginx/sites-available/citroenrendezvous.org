...
server {
  ...
  ssl_certificate /etc/nginx/ssl/certs/citroenrendezvous.org/citroenrendezvous_org_chain.crt;
  ssl_certificate_key /etc/nginx/ssl/certs/citroenrendzvous.org/rendezvous.private.key;
